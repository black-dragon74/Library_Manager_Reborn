 ...
 * @author nick
 */
public class activation_form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Activation | Library Manager Reborn");
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(activation_form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
